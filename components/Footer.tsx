...
import { Mail, Phone, Facebook, Instagram, Twitter, Linkedin, ArrowRight } from 'lucide-react';
import './Footer.css';
    ...
    <footer className="footer-section">
      ...
      <div className="footer-container">
        ...
        <div className="footer-top-header">
          <h2 className="footer-cta-text">Let's Connect with us</h2>
        </div>
        ...
        <div className="footer-main-grid">
          ...
          <div className="footer-brand-col">
            <h3 className="footer-logo-brand">Niche Geeky</h3>
            ...
            <div className="footer-contact-info">
              ...
              <a href="mailto:hellonichegeeky@gmail.com" className="contact-item">
                <Mail size={16} />
                <span>hellonichegeeky@gmail.com</span>
              </a>
              <a href="tel:+8807683674747" className="contact-item">
                <Phone size={16} />
          ...
          <div className="footer-links-group">
            ...
            <div className="footer-links-col">
              ...
              <ul>
                <li><a href="#">People platform</a></li>
                <li><a href="#">Full-service payroll</a></li>
                <li><a href="#">Employee Benefits</a></li>
                <li><a href="#">Hiring and onboarding</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          ...
          <div className="social-links">
            <a href="#" className="social-icon-circle"><Facebook size={16} /></a>
            <a href="#" className="social-icon-circle"><Instagram size={16} /></a>
            <a href="#" className="social-icon-circle">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
            <a href="#" className="social-icon-circle"><Linkedin size={16} /></a>
          </div>
        </div>
      </div>
    </footer>
